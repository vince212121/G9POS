  ...
  return (
    <section className='flex flex-row justify-center mt-5'>
      ...
      onClick={prevSlide}>
        ...
        strokeWidth="2" 
        d="m11 15-3-3m0 0 3-3m-3 3h8M3 12a9 9 0 1 1 18 0 9 9 0 0 1-18 0z"/></svg>
      </div>
      {SliderData.map((slide, index) => {
        return (
          ...
          >
            {index === current && (
              <img src={slide.image} alt='travel image' className='w-11/12 h-3/5 ml-0 ' />
            )}
          </div>
        );
      })}
      ...
      onClick={nextSlide}>
        ...
        strokeLinejoin="round" 
        strokeWidth="2" 
        d="m13 9 3 3m0 0-3 3m3-3H8m13 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0z"/></svg>
      </div>
    </section>
  );
};
