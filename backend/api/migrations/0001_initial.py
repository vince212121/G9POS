    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previousVendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.previousvendororder')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.inventory')),
                ('previousCustomer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.previouscustomerorder')),
            ],
        ),
        migrations.CreateModel(
            name='User',
